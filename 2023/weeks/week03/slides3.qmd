...
<img src="/figures/images/tidy1.png" alt="Source:R for Data Science" width="400" height="350" style="display: block; margin: 0 auto;"/>
  
## Untidy data {.smaller}

<img src="/figures/images/untidy.png" alt="Source: US Census Fact Finder, General Economic Characteristics, ACS 2017" width="500" height="300" style="display: block; margin: 0 auto;"/>
...
<img src="/figures/images/tidy4.png" alt="Source: R for Data Science" width="400" height="400" style="display: block; margin: 0 auto;"/>
...
- The names of the ID### columns rotate into an index row (number), and the measure values shift over to the corresponding number
and group
...
- Select the variables that capture the information related to deaths, injuries,
homelessness caused by all disasters. You can rename the variables
