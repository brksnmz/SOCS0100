...
<img src="/figures/images/if.png" alt="Source:R for Data Science" width="400" height="400" style="display: block; margin: 0 auto;"/>
...
- Both the "if" and "function" statements should almost always be accompanied by curly braces `{},` and the code within them should be indented. This practice enhances code readability

- Start opening curly braces on a new line, close them on their own line, except when followed by "else," and maintain code indentation inside them
...
<img src="/figures/images/functions.png" alt="Source:https://www.learnbyexample.org/" width="500" height="500" style="display: block; margin: 0 auto;"/>
